...
from UDPFile_receiver import UDPFile_receiver, PARSE_RETURNS
import numpy as np
import sys
import select
...
receiver_states = {"file_request": 0, \
                ...
                "write_and_send_acknowledge_new": 5, \
                "write_and_send_acknowledge_current": 6, \
                "end_receiver": 7}
...
while True:
    ...
    if CURRENT_STATE == receiver_states["file_request"]:
        ...
        success, data = wait_for_response(sock_receive, timeout=SOCKET_TIMEOUT)
        ...
        if not success:
            ...
            if ret_dict["return"] == PARSE_RETURNS["request_unsuccessful"] or \
                ...
                print(f"WARNING: ret_dict: request_unsuccessful, wrong_message_type, wrong_crc")
                CURRENT_STATE = receiver_states["file_request"]
                continue
        ...
        pass
    elif CURRENT_STATE == receiver_states["write_and_send_acknowledge_new"]:
        pass
    elif CURRENT_STATE == receiver_states["write_and_send_acknowledge_current"]:
        pass
