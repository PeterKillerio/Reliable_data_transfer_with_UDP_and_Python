...
sender_states = {"file_request_wait": 0, \
                "file_start_transfer_wait": 1, \
                "sending_file_data": 2, \
                "wait_for_acknowledge": 3, \
                "end_sender": 4}
...
# Main while loop
while True:
    if CURRENT_STATE == receiver_states["file_request_wait"]:
        pass
    elif CURRENT_STATE == receiver_states["file_start_transfer_wait"]:
        pass
    elif CURRENT_STATE == receiver_states["sending_file_data"]:
        pass
    elif CURRENT_STATE == receiver_states["wait_for_acknowledge"]:
        pass
    elif CURRENT_STATE == receiver_states["end_sender"]:
        pass
